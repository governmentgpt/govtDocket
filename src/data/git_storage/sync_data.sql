-- WikiGov Ingestion Sync - 2026-07-22T03:27:16.521Z
BEGIN;

-- Ingest Document & Version
INSERT INTO documents (id, original_url, doc_type, issuing_authority) VALUES ('42045c7c-f22b-4337-8406-a783cfb76acd', 'https://www.tn.gov.in/go_ms_118', 'Government Order', 'Social Welfare and Women Empowerment Department') ON CONFLICT (id) DO NOTHING;
INSERT INTO document_versions (id, document_id, version_number, title, effective_date, sha256_hash) VALUES ('919604a0-ffe1-4cff-993f-eb7cd6c90c4a', '42045c7c-f22b-4337-8406-a783cfb76acd', 1, 'Kalaignar Magalir Urimai Thittam - Guidelines', '2026-07-14', 'f2b187b63fabdf4edddc5f56de9084ec90ebca64c1fe74eec8060356c32a13a4') ON CONFLICT DO NOTHING;
...
ORDER:
The Government of Tamil Nadu hereby registers the basic guidelines for the Kalaignar Magalir Urimai Thittam scheme.') ON CONFLICT (id) DO NOTHING;
INSERT INTO passages (id, version_id, page_number, section_label, text_content) VALUES ('b0fafd8c-dfa5-4569-ab13-e60ad28d2d64', '919604a0-ffe1-4cff-993f-eb7cd6c90c4a', 2, 'Page 1', '1: The scheme provides a monthly financial support of Rs. 1,000 to eligible women heads of households.') ON CONFLICT (id) DO NOTHING;
INSERT INTO passages (id, version_id, page_number, section_label, text_content) VALUES ('b664dba1-c99b-4fe6-8e38-778b1471fd3c', '919604a0-ffe1-4cff-993f-eb7cd6c90c4a', 3, 'Page 2', '2: Eligible applicants must be women who are permanent residents of Tamil Nadu, above 21 years of age, and whose annual household income is below Rs. 2.5 Lakhs.') ON CONFLICT (id) DO NOTHING;
INSERT INTO passages (id, version_id, page_number, section_label, text_content) VALUES ('f22a3184-2673-43b0-8248-b70455e0ad5d', '919604a0-ffe1-4cff-993f-eb7cd6c90c4a', 4, 'Page 3', '3: Applications must be submitted through the designated registration camps. Required documents include Aadhaar Card, Smart Family Card, and Income Certificate.') ON CONFLICT (id) DO NOTHING;
...
INSERT INTO node_aliases (node_id, alias, language) VALUES ('widow-pension-scheme', 'Kalaignar Magalir Scheme', 'undefined') ON CONFLICT DO NOTHING;
INSERT INTO node_aliases (node_id, alias, language) VALUES ('widow-pension-scheme', 'Magalir Urimai Thittam', 'undefined') ON CONFLICT DO NOTHING;
INSERT INTO node_aliases (node_id, alias, language) VALUES ('widow-pension-scheme', 'மகளிர் உரிமைத் திட்டம்', 'undefined') ON CONFLICT DO NOTHING;
...
INSERT INTO node_aliases (node_id, alias, language) VALUES ('dept-social-welfare', 'Social Welfare Department', 'undefined') ON CONFLICT DO NOTHING;
INSERT INTO node_aliases (node_id, alias, language) VALUES ('dept-social-welfare', 'சமூக நலத்துறை', 'undefined') ON CONFLICT DO NOTHING;

-- Ingest Edges & Evidence
INSERT INTO edges (id, from_node_id, to_node_id, relationship_type) VALUES ('4fd5bf79-d087-414d-82cb-a39d76593d1d', 'widow-pension-scheme', 'dept-social-welfare', 'governed_by') ON CONFLICT (id) DO NOTHING;
INSERT INTO edge_evidence (edge_id, passage_id, approved_by) VALUES ('4fd5bf79-d087-414d-82cb-a39d76593d1d', '4439b5d2-f6f2-446a-b54b-725557b2fc08', 'system-ingest-steward') ON CONFLICT DO NOTHING;
